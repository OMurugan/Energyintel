...
Monthly gas demand analytics by country
"""
    ...
    return html.Div([
        html.Div([
            html.Div([
                ...
                html.H2("European Gas Demand - Monthly Demand by Country", style={
                ...
                html.P("Monthly gas demand analytics by country coming soon.", style={
