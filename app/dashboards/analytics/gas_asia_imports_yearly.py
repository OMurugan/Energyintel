"""
Asian Gas Trade - Yearly Imports by Origin
Yearly gas imports analytics by origin for Asia
"""
...
def create_layout():
    ...
    return html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.I(className="fas fa-truck-loading", style={
                        'fontSize': '80px', 'color': '#fe5000', 'marginBottom': '30px'
                    })
                ], style={'textAlign': 'center'}),
                html.H2("Asian Gas Trade - Yearly Imports by Origin", style={
                ...
                html.P("Asian yearly gas imports analytics by origin coming soon.", style={
