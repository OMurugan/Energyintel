...
def create_layout():
    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.Div([
                    ...
                    dcc.Checklist(
                        ...
                        style={'fontSize': '12px', 'color': '#666', 'padding': '5px', 'border': '1px solid #ddd', 'backgroundColor': 'white', 'maxHeight': '150px', 'overflowY': 'auto'},
            ...
            ], style={'width': '150px', 'order': '2', 'marginLeft': '15px'}),
            ...
            html.Div([
                ...
                html.Div(id='gas-flows-table-container', style={'marginTop': '20px'})
...
def register_callbacks(dash_app, server):
    ...
    @dash_app.callback(
        ...
        [Input('gas-flows-start-date', 'date'),
         Input('gas-flows-end-date', 'date'),
    ...
    def update_gas_flows_table(start_date, end_date, selected_origins):
        ...
        try:
            ...
            # Aggregate
            df = df.groupby(['Day of Date', 'Header_Exporter', 'gas_origin', 'Header_Importer', 'target_country', 'Interconnection Point'])['flows_bcm'].sum().reset_index()
