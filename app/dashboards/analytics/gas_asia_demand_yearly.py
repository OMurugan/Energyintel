...
Yearly gas demand analytics for Asia
"""
    ...
    return html.Div([
        html.Div([
            html.Div([
                ...
                html.H2("Asian Gas Demand - Yearly Gas Demand", style={
                ...
                html.P("Asian yearly gas demand trends and analytics coming soon.", style={
