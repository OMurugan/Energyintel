...
def register_dashboards(app):
    ...
    from app import create_dash_app # Import create_dash_app
    ...
    wcod_dash_app = create_dash_app(app, '/wcod/') # Create dash_app here
    wcod_dash = create_wcod_dashboard(wcod_dash_app, app, '/wcod/') # Pass dash_app to create_wcod_dashboard
