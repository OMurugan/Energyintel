...
def create_layout():
    ...
    return html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.I(className="fas fa-globe-europe", style={
                        'fontSize': '80px', 'color': '#fe5000', 'marginBottom': '30px'
                    })
                ], style={'textAlign': 'center'}),
                html.H2("European Gas Trade - Pipeline Flows by Country", style={
                ...
                html.P("Country-specific pipeline flow analytics and insights coming soon.", style={
