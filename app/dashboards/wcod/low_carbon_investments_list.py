...
def create_layout():
    ...
    return html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.I(className="fas fa-list-ul", style={
                        'fontSize': '80px', 'color': '#28a745', 'marginBottom': '30px'
                    })
                ], style={'textAlign': 'center'}),
                html.H2("List of Tracked Investments", style={
                ...
                html.P("Comprehensive list of tracked low-carbon investments coming soon.", style={
