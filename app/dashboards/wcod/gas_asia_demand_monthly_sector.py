...
Monthly gas demand analytics by sector for Asia
"""
from dash import dcc, html


def create_layout():
    """Create the Asian Monthly Demand by Sector layout"""
    return html.Div([
        html.Div([
            html.Div([
                html.Div([
                ...
                html.H2("Asian Gas Demand - Monthly Demand by Sector", style={
                ...
                html.P("Asian monthly gas demand analytics by sector coming soon.", style={
