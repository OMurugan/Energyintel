"""
Asia World Gas Dashboard
Comprehensive Asian gas analytics dashboard
"""
from dash import dcc, html


def create_layout():
    """Create the Asia Gas Dashboard layout"""
    return html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.I(className="fas fa-globe-asia", style={
                        'fontSize': '80px', 'color': '#fe5000', 'marginBottom': '30px'
                    })
                ], style={'textAlign': 'center'}),
                html.H2("Asia World Gas Dashboard", style={
                ...
                html.P("Comprehensive Asian gas market analytics dashboard coming soon.", style={
